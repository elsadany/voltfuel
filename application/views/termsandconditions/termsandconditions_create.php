        ...
        <div class="content container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card mb-0">
                        <div class="card-body">
                            <form id="form1" action="<?php echo site_url('admin/termsandconditions/create') ?>"  id="termsandconditionsform" name="termsandconditionsform" method="post" accept-charset="utf-8">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea rows="4" class="form-control summernote" placeholder="Enter your message here" name="termsandconditions" id="termsandconditions" required></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="text-end">
