							...
							<div class="col-md-5">
								...
								<div class="col-sm-12 col-lg-12 col-xl-12 m-b-20">
									<ul class="list-unstyled invoice-payment-details">
										...
										<li>Finished On : <span><?php echo $orderdetails['returned_date'].", at ". $orderdetails['returned_time']; ?></span></li>
								...
								<div class="col-sm-12 col-lg-12 col-xl-12 m-b-20">
									<ul class="list-unstyled invoice-payment-details">
										<li>Total : <span><?php echo $orderdetails['total_amount'] ?></span></li>
									</ul>
								</div>
								<div class="col-md-4" style="float:left">
									<!-- <a href="" id="pagePrint" class="btn add-btn"><i class="fa fa-print"></i>Print</a>  -->
									<a href="<?php echo base_url(); ?>admin/orders/print/<?php echo $this->enc_lib->encrypt($orderdetails['order_id']); ?>"  class="btn add-btn"><i class="fa fa-print"></i>Print</a> 
								</div>
							</div>
							<div class="col-md-7">
								...
								<input type="hidden" name="returned_lati" id="returned_lati" value="<?php echo $orderdetails['returnedlat']; ?>">
								<input type="hidden" name="returned_lang" id="returned_lang" value="<?php echo $orderdetails['returnedlng']; ?>">
								<input type="hidden" name="issued_title" id="issued_title" value="<?php echo $orderdetails['issuedoutlet']; ?>">
								<input type="hidden" name="returned_title" id="returned_title" value="<?php echo $orderdetails['returnedoutlet']; ?>">
...
// let tbl_returned_lati = "<?= $orderdetails['returnedlat']; ?>";
// let tbl_returnedlati = parseFloat(tbl_returned_lati);
// let tbl_returned_lang = "<?= $orderdetails['returnedlng']; ?>";
// let tbl_returnedlang = parseFloat(tbl_returned_lang);
// let tbl_issuedtitle ="<?= $orderdetails['issuedoutlet']; ?>";
// let tbl_returntedtitle = "<?= $orderdetails['returnedoutlet']; ?>";
...
//     });
    ...
    // const tbl_returntedlatLng = new google.maps.LatLng(tbl_returnedlati, tbl_returnedlang);
    // marker4 = new google.maps.Marker({
    // position: tbl_returntedlatLng,
    // icon: {
    //   scaledSize: new google.maps.Size(50, 50),
