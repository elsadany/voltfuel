...
class Admin_Controller extends MY_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model(array('filetype_model'));
...
class Subscribers_Controller extends MY_Controller
{

    public function __construct()
    {
        parent::__construct();
        $this->load->library('subscribermodule_lib');
        $this->config->load('app-config');
        $this->auth->is_logged_in_user('subscriber');
    }
...
class Front_Controller extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->helper('language');
        $this->company_details = $this->setting_model->getCompanyDetail();
        redirect('site/login');
        
        $this->theme_path = $this->front_setting->theme;
//================
        $language = ($this->company_details->language);
