...
class Customlib
{
    ...
    public function getCurrencyFormat()
    {
        ...
        } else if ($this->CI->session->userdata('subscriber')) {
            
            $student = $this->CI->session->userdata('subscriber');
            return $student['currency_symbol'];
        }

    }

    public function getCurrencysymbolwithalignment()
    {
    ...
    public function getCurrencyWithPlace($amount = 0)
    {
        $admin = $this->CI->session->userdata('admin');
    ...
    public function getAppName()
    {
        $admin = $this->CI->session->userdata('admin');
        if ($admin) {
            return $admin['cmp_name'];
        } else if ($this->CI->session->userdata('subscriber')) {
            $subscriber = $this->CI->session->userdata('subscriber');
            return $subscriber['cmp_name'];
        }
    }
    ...
    public function setUserLog($username, $role, $device_id = null)
    {
