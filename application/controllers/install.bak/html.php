...
<html lang="en">
    <head>
        ...
        <title>VoltaFuel - Rental Equipments Management System Installation</title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-9"><h3 class="header">EquipRent : Rental Equipments Management System - Installer</h3></div>
                    </div><!--./col-md-12-->
                </div><!--./row-->
            </div><!--./container-->
        </div><!--./row-->
                    ...
                    <div class="col-md-9 col-sm-9">
                        <div class="newbox new-box-primary">
                            ...
                            <?php } else if ($step == 4) { ?>
                                ...
                                <p><b>Please note that in EquipRent there are two login panels -</b></p>
                                <ul style="list-style: disc; margin-left: 15px;">
                                    <li><span style="color: #0084B4; padding-right: 5px;"><?php echo base_url(); ?>site/login</span> Admin Panel : this panel is used for Manager/Administrator login.</li>
                                    <li><span style="color: #0084B4; padding-right: 5px;"><?php echo base_url(); ?>site/userlogin</span> User Panel : this panel is used for Subscriber login.</li>
                                </ul>
                            <?php } ?>
